...
for i in range(ntrees):
    ...
    if tAB<tau2:   # A and B coalesce in their ancestral interval
        ...
        if tABC<tau3:  # AB and C coalesce in their ancestral interval
            ...
            print '[1](((2:'+tApr+',3:'+tBpr+'):'+tABpr+',4:'+tCpr+'):'+tABCpr+',1:'+tDpr+');'
            count[0] = count[0]+1
            ...
            if ran1<1.0/3.0:  #AB and C coalesce first, above the root
                ...
                print '[1](((2:'+tApr+',3:'+tBpr+'):'+tABpr+',1:'+tDpr+'):'+tABDpr+',4:'+tCpr+');'
                count[26] = count[26] + 1
                ...
                print '[1]((2:'+tApr+',3:'+tBpr+'):'+tABpr+',(4:'+tCpr+',1:'+tDpr+'):'+tCDpr+');'
                count[28] = count[28] + 1
        ...
        if time1<tau3: # there is a coalescent event in population ABC
            ...
            if ran1<1.0/3.0: # A and B coalesce first in population ABC
                ...
                if time2<tau3-tAB: # AB and C coalesce in population ABC
                    ...
                    if ran2<1.0/3.0: #AB and C coalesce first, above the root
                        ...
                        print '[1]((2:'+tApr+',3:'+tBpr+'):'+tABpr+',(1:'+tDpr+',4:'+tCpr+'):'+tCDpr+');'
                        count[33] = count[33] + 1
                ...
                if time2<tau3-tAC:  # AC and B coalesce in population ABC
                    ...
                    tDpr = str(thetaD*(tau1+tau2+tau3)+thetaABCD*tABCD)
                    print '[1](((2:'+tApr+',4:'+tCpr+'):'+tACpr+',3:'+tBpr+'):'+tABCpr+',1:'+tDpr+');'
                    count[5] = count[5]+1
                    ...
                    if ran1<1.0/3.0: # AC and B coalesce first, above the root
                        ...
                        print '[1](((2:'+tApr+',4:'+tCpr+'):'+tACpr+',1:'+tDpr+'):'+tACDpr+',3:'+tBpr+');'
                        count[29] = count[29] + 1
                        ...
                        print '[1]((2:'+tApr+',4:'+tCpr+'):'+tACpr+',(1:'+tDpr+',3:'+tBpr+'):'+tBDpr+');'
                        count[30] = count[30] + 1
                ...
                if time2<tau3-tBC: # BC and A coalesce in population ABC
                    ...
                    tDpr = str(thetaD*(tau1+tau2+tau3)+thetaABCD*tABCD)
                    print '[1](((3:'+tBpr+',4:'+tCpr+'):'+tBCpr+',2:'+tApr+'):'+tABCpr+',1:'+tDpr+');'
                    count[10] = count[10] + 1
                    ...
                    if ran1<1.0/3.0: # BC and A coalesce first, above the root
                        ...
                        print '[1](((3:'+tBpr+',4:'+tCpr+'):'+tBCpr+',1:'+tDpr+'):'+tBCDpr+',2:'+tApr+');'
                        count[31] = count[31] + 1
                        ...
                        print '[1]((3:'+tBpr+',4:'+tCpr+'):'+tBCpr+',(1:'+tDpr+',2:'+tApr+'):'+tADpr+');'
                        count[32] = count[32] + 1
            ...
            if ran1<1.0/6.0: # A and B coalesce first
                ...
                if ran2<1.0/3.0:  # AC and B coalesce next
                    ...
                    print '[1]((2:'+tApr+',4:'+tCpr+'):'+tACpr+',(3:'+tBpr+',1:'+tDpr+'):'+tBDpr+');'
                    count[16] = count[16] + 1
                ...
                if ran2<1.0/3.0: # BC and A coalesce next
                    ...
                    print '[1]((3:'+tBpr+',4:'+tCpr+'):'+tBCpr+',(2:'+tApr+',1:'+tDpr+'):'+tADpr+');'
                    count[14] = count[14] + 1
                ...
                if ran2<1.0/3.0:  # AD and B coalesce next
                    ...
                    print '[1](((2:'+tApr+',1:'+tDpr+'):'+tADpr+',3:'+tBpr+'):'+tABDpr+',4:'+tCpr+');'
                    count[17] = count[17] + 1
                    ...
                    print '[1](((2:'+tApr+',1:'+tDpr+'):'+tADpr+',4:'+tCpr+'):'+tACDpr+',3:'+tBpr+');'
                    count[18] = count[18] + 1
                    ...
                    print '[1]((2:'+tApr+',1:'+tDpr+'):'+tADpr+',(4:'+tCpr+',3:'+tBpr+'):'+tBCpr+');'
                    count[19] = count[19] + 1
                ...
                if ran2<1.0/3.0: # BD and A coalesce next
                    ...
                    print '[1](((3:'+tBpr+',1:'+tDpr+'):'+tBDpr+',2:'+tApr+'):'+tABDpr+',4:'+tCpr+');'
                    count[20] = count[20] + 1
                    ...
                    print '[1](((3:'+tBpr+',1:'+tDpr+'):'+tBDpr+',4:'+tCpr+'):'+tBCDpr+',2:'+tApr+');'
                    count[21] = count[21] + 1
                    ...
                    print '[1]((3:'+tBpr+',1:'+tDpr+'):'+tBDpr+',(4:'+tCpr+',2:'+tApr+'):'+tACpr+');'
                    count[22] = count[22] + 1
                ...
                if ran2<1.0/3.0:  # CD and A coalesce next
                    ...
                    print '[1](((4:'+tCpr+',1:'+tDpr+'):'+tCDpr+',2:'+tApr+'):'+tACDpr+',3:'+tBpr+');'
                    count[23] = count[23] + 1
                    ...
                    print '[1](((4:'+tCpr+',1:'+tDpr+'):'+tCDpr+',3:'+tBpr+'):'+tBCDpr+',2:'+tApr+');'
                    count[24] = count[24] + 1
                    ...
                    print '[1]((4:'+tCpr+',1:'+tDpr+'):'+tCDpr+',(3:'+tBpr+',2:'+tApr+'):'+tABpr+');'
                    count[25] = count[25] + 1
